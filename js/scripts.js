$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Will and Marybeth's Wedding",

            // Event start date
            start: new Date('January 19, 2024 17:30'),
            ...
            end: new Date('January 19, 2024 20:30'),

            // Event Address
            address: '송파구 송파동 48-7 Seoul, Korea',
...
// Google map
function initMap() {
    var location = {lat: 37.51502, lng: 127.01648};
...
function initBBSRMap() {
    var la_fiesta = { lat: 37.51502, lng: 127.01648 };
    var map = new google.maps.Map(document.getElementById('map-canvas'), {
        zoom: 15,
        center: la_fiesta,
        scrollwheel: false
